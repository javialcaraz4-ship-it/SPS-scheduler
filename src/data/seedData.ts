...
const rawShifts: Shift[] = [
  // MONDAY
  ...expandShifts({ schoolId: 'sc_gissv',    coachId: coachId('Jessica'), sport: 'Basketball', dayOfWeek: 'Monday',    startDate: '2026-09-14', endDate: '2027-01-11', startTime: '3:35pm', endTime: '4:35pm', noClass: '10/12, 11/23, 12/21, 12/28', payRate: 45 }),
  ...
  ...expandShifts({ schoolId: 'sc_gabmis',   coachId: coachId('Quique'),  sport: 'Basketball', dayOfWeek: 'Monday',    startDate: '2026-09-14', endDate: '2026-11-02', startTime: '2:40pm', endTime: '3:40pm', noClass: '',                            payRate: 60 }),
  ...
  ...expandShifts({ schoolId: 'sc_lascuola', coachId: coachId('Justin'),  sport: 'Basketball', dayOfWeek: 'Wednesday', startDate: '2026-09-09', endDate: '2026-11-11', startTime: '3:40pm', endTime: '4:40pm', noClass: '10/14',                    payRate: 70 }),
  ...expandShifts({ schoolId: 'sc_lascuola', coachId: coachId('Justin'),  sport: 'Basketball', dayOfWeek: 'Wednesday', startDate: '2026-09-09', endDate: '2026-11-11', startTime: '4:40pm', endTime: '5:40pm', noClass: '10/14',                    payRate: 70 }),
  ...
  // THURSDAY
  ...expandShifts({ schoolId: 'sc_laslom',   coachId: coachId('Jessica'), sport: 'Basketball', dayOfWeek: 'Thursday',  startDate: '2026-09-03', endDate: '2026-12-03', startTime: '3:30pm', endTime: '4:30pm', noClass: '11/12, 11/26', payRate: 45 }),
  ...
  ...expandShifts({ schoolId: 'sc_ponderosa',coachId: coachId('Peter'),   sport: 'Soccer',     dayOfWeek: 'Thursday',  startDate: '2026-09-17', endDate: '2026-11-05', startTime: '2:00pm', endTime: '3:40pm', noClass: '',              payRate: 80 }),
  ...
  ...expandShifts({ schoolId: 'sc_synapse',  coachId: coachId('Jessica'), sport: 'Basketball', dayOfWeek: 'Friday',    startDate: '2026-09-18', endDate: '2026-12-18', startTime: '2:45pm', endTime: '3:45pm', noClass: '10/13',                    payRate: 45 }),
];
